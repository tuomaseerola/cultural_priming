...
```{r plot1, fig.width=10.5,fig.height=7,warning=FALSE,message=FALSE}
...
Does _Major--Diminished_ chord pair provide significantly stronger evidence than _Major--Augmented_ pair using the posterior distributions? How much?
